import { A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, c as createComponent, u as unescapeHTML, e as renderTemplate, h as renderUniqueStylesheet, i as renderScriptElement, j as createHeadAndContent, f as renderComponent, a as createAstro } from '../../chunks/astro/server_DUtPMUiz.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('../../chunks/_astro_data-layer-content_CazmtJZE.mjs');
...
function createGetEntry({
  ...
  return async function getEntry(collectionOrLookupObject, _lookupId) {
    ...
    if (store.hasCollection(collection)) {
      ...
      const { default: imageAssetMap } = await import('../../chunks/content-assets_BY7V9Uyi.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('../../chunks/_astro_assets_Brm2rGd8.mjs').then(n => n._);
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { Content } = await renderEntry(blogPost);
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Content", Content, {})} ` })}`;
}, "/Users/N.Haberkamp/Code/astro-bug-report-devtools/src/pages/blog/[slug].astro", void 0);

const $$file = "/Users/N.Haberkamp/Code/astro-bug-report-devtools/src/pages/blog/[slug].astro";
const $$url = "/blog/[slug]";
